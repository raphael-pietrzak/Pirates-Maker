...
class Menu:
	...
	def create_buttons(self):
		...
		size_y = 180
		margin = 6
		topleft = (WINDOW_WIDTH - size_x - margin,WINDOW_HEIGHT - size_y - margin)
		self.rect = pygame.Rect(topleft,(size_x,size_y))

		# button areas
		button_size = 90
		generic_button_rect = pygame.Rect(self.rect.topleft, (button_size, button_size))
		button_margin = 5
		self.tile_button_rect = generic_button_rect.copy().inflate(-button_margin,-button_margin)
		self.coin_button_rect = generic_button_rect.move(button_size,0).inflate(-button_margin,-button_margin)
		self.enemy_button_rect = generic_button_rect.move(button_size,button_size).inflate(-button_margin,-button_margin)
		self.palm_button_rect = generic_button_rect.move(0,button_size).inflate(-button_margin,-button_margin)
