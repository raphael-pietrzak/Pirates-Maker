...
EDITOR_DATA = {
    ...
    19: {'style': 'phase', 'type': 'object', 'menu': 'phase', 'menu_surf': '../graphics/menu/end.png', 'preview': '../graphics/preview/end.png', 'graphics': None}
}
...
HEALTH_COLOR = '#e05353'
OVERWORLD_BG_COLOR = '#E0CDAC'
OVERWORLD_FG_COLOR = '#D1AA9D'
OVERWORLD_LINES = '#9B5544'